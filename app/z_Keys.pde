...
void bolaMedievalKeys() {
  X_BOLA_MEDIEVAL = changeVariable(X_BOLA_MEDIEVAL, 0, 0, 0, amountChange)[0];
  Y_BOLA_MEDIEVAL = changeVariable(0, Y_BOLA_MEDIEVAL, 0, 0, amountChange)[1];
}
